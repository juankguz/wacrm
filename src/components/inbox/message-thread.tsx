...
export function MessageThread({
  ...
  const contactDisplayName =
    contact?.name || contact?.whatsapp_username || contact?.phone || "Customer";
  ...
  const displayName =
    contact.name || contact.whatsapp_username || contact.phone || t("whatsappUser");
        ...
        <div className="flex min-w-0 items-center gap-2 sm:gap-3">
          ...
          <div className="min-w-0">
            ...
            <p className="truncate text-xs text-muted-foreground">
              {contact.phone || contact.whatsapp_username || t("whatsappUser")}
            </p>
          </div>
                      ...
                      ? {
                          authorLabel:
                            parent.sender_type === "agent" || parent.sender_type === "bot"
                              ? t("me") 
                              : contact?.name || contact?.whatsapp_username || contact?.phone || "Unknown",

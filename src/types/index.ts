...
export interface Contact {
  ...
  /** Meta Business-scoped User ID (BSUID). The stable new identity for
   *  users whose phone number may be omitted from webhooks (migration
   *  037). Absent for phone-only contacts. */
  whatsapp_user_id?: string | null;
  /** WhatsApp username, when the user adopted one. */
